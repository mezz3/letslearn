...
var myQuestions = [
  {
    ...
    correctAnswer: "d",
    ans: "เฉลย d (เนื่องจากจำนวนนับคือจำนวนเต็มบวกและจำนวนเต็มบวกที่หารด้วย 3 ลงตัวแต่ไม่เกิน 30 คือ 3 , 6 , 9 , ... , 30 ในขณะที่ตัวเลือกที่ 1 และ 2 มี 0 เป็นสมาชิกโดยที่ 0 ไม่ใช่จำนวนนับ และตัวเลือก d ไม่มี 30)"
  },
  {
    ...
    correctAnswer: "b",
    ans: "เฉลย b  (ค่า x ที่สอดคล้องกับสมการ ( x - 1 ) ( x + 1 ) ( x - 2 ) ( x + 3 ) = 0 คือ x = -3 , -1 , 1 , 2 แต่ -3 และ -1 ไม่ใช่จำนวนนับ จึงเหลือค่า x ที่เป็นจำนวนนับคือ x = 1 , 2 เท่านั้น)"
  },
  {
    ...
    correctAnswer: "c",
    ans: "เฉลย c  (จาก A = { 2 , 4 , { 4 , 5 } } เราจะเห็นได้ว่า A มี 3 สมาชิกคือ 2 , 4 และ { 4 , 5 } เมื่อนักเรียนสามารถหา สมาชิกทั้ง 3 ตัวของ A ได้ ก็จะทราบได้ทันทีว่า { { 4 , 5 } } นั้นไม่เป็นสมาชิกของ A)"
  ...
  },
  {
    ...
    correctAnswer: "d",
    ans: "เฉลย d เพราะว่า A = { 1 , 2 , 12 } ดังนั้น A มี 3 สมาชิก และ A ไม่เท่ากับ B ดังนั้นข้อที่ถูกต้องคือ ข้อ d"
  ...
  },
  {
    ...
    correctAnswer: "b",
    ans: "เฉลย b เพราะว่า { 4 , 4 , 3 , 2 , 1 } = { 4 , 3 , 2 , 1 } = { 1 , 2 , 3 , 4 } ข้อ ก จึงถูกต้อง เนื่องจาก 1 ∈ { 1 , 2 , 3 } แต่ 1 ∈ { 123 } ดังนั้นข้อ ข ไม่ถูกต้อง"
